...
| 17 | `gof_creational` | `gof_prototype` | `dup/clone` | **90%** [VERY_HIGH] | `authenticatable.rb:107` | Creational pattern creating new objects by cloning prototypical instances via dup, clone, or initialize_copy. |
